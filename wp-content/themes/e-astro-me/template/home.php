...
get_header(); ?>
    ...
    <section id="hero" class="hero-section-2">
                    ...
                    <div class="col-lg-5 col-xl-6">
                        <div class="hero-info ">
                            <div class="section-heading">
                                ...
                                <h4 class="section-title anim-text">A MULTINATIONAL <br> BUSINESS LEADER </h4>
            ...
            <section id="about" class="about-section-2 pt-130 overflow-x">
                <div class="container">
                    <div class="row about-wrap-2 gy-lg-0 gy-4">
                        ...
                        <div class="col-lg-7 col-md-12">
                            <div class="about-content-2 fade-wrapper">
                                <div class="section-heading">
                                    <h3 class="sub-heading after-none anim-text mb-30" data-text-animation="fade-in"
                                        data-duration="1.5">About Our Company</h3>
                                    <p class="pr-30">Welcome to E-Astro Company Ltd., a trusted trading company
                                        dedicated to
            ...
            <div class="container ">
                <div class="section-heading text-center ">
                    <h4 class="sub-heading after-none" data-text-animation="fade-in" data-duration="1.5">Our Company
                        Summary</h4>
                </div>
            ...
            <section class="certificates-awerd pt-120 pb-120">
                <div class="container">
                    <div class="section-heading text-center mb-30">
                        <h3 class="sub-heading after-none anim-text" data-text-animation="fade-in" data-duration="1.5">
                            Certification and Award State</h3>
                    </div>
                            ...
                            <div class="col-lg-7 col-md-12">
                                <div class="about-content-3 fade-wrapper">
                                    <div class="section-heading mb-0">
                                        <h2 class="section-title text-justify" data-text-animation="fade-in-right"
                                            data-split="char" data-duration="0.6" data-stagger="0.03">Our
            ...
            <section class="container arcitace pt-120">
                <div class="row">
            ...
            <section class="cta-section pt-130 pb-120">
                <div class="container">
                    <div class="cta-wrap text-center">
                        <div class="section-heading text-center mb-80">
                            <h3 class="sub-heading after-none anim-text" data-text-animation="fade-in"
                                data-duration="1.5">Let’s make something <br>great
                                together!</h3>
                        </div>
            ...
            <section class="container pb-80 text-center">
                ...
                <div class="section-heading text-center">
                    <h3 class="sub-heading after-none anim-text" data-text-animation="fade-in" data-duration="1.5">
                        ...
                        AUTOMATIC SOCK KNITTING MACHINE</h3>
                </div>
